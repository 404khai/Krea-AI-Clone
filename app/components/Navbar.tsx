...
const Navbar = () => {
  return (
    <nav className='w-full h-20 bg-white flex items-center justify-evenly'>
      ...
      <div className='bg-[#f5f5f5] bg-primary-100 dark:bg-primary-850 w-100 flex justify-evenly items-center rounded-2xl mx-auto backdrop-blur-2xl transition-[transform,opacity,scale,translate,background-color] select-none duration-[500ms] ease-[cubic-bezier(0,1,.35,1)]'>
