...
const Footer = () => {
  return (
    <footer className='bg-[#2e2e2e] flex items-center justify-between w-full h-30'>
        <div className='flex items-center justify-evenly w-50 h-[80%] bg-cyan-950'>
        ...
        <div className='flex items-center justify-center gap-4 w-70 h-[80%] bg-teal-400'>
            <h1>curated by</h1>
            <div className='flex items-center justify-center gap-1 w-[50%] h-full bg-amber-300'>
