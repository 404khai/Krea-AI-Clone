...
const HeroSection = () => {
  return (
    <>
        ...
        <div className='dark:bg-[#0f0f0f] bg-white h-fit flex flex-col items-center'>
            <div className='w-[95%] h-fit flex items-center justify-between mb-4'>
                <h3 className='text-xl font-medium dark:text-white'>Generate</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-y-6 gap-3 px-4 w-full mb-10">
                    {/* Row 1 */}
                <GenerateCard
                ...
                <GenerateCard
                    ...
                    background="bg-[#ffa700] text-white dark:text-white"
                />
                <GenerateCard
            ...
            <div className='w-[95%] h-fit flex items-center justify-between mb-4'>
                <h3 className='text-xl font-medium dark:text-white'>Gallery</h3>
