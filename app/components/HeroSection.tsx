  ...
  return (
    <>
        ...
        <div className='w-[95%] h-fit flex items-center justify-between'>
            <h3 className='text-xl'>Generate</h3>
            <p className='flex items-center text-[#2781d6] text-sm'>
                <ChevronDown/>
                Show all
            </p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-4 pl-4 pr-4 pb-10 w-full h-50">
                {/* Row 1 */}
            <GenerateCard
